...
function s(t, e) {
    if (e) for (;it.isCollision(t, e); ) t.start.x > 0 ? t.start.y-- : t.start.x < 0 ? t.start.y++ : t.start.y > 0 ? t.start.y++ : t.start.y--;
    return t;
}
...
function _(t) {
    ...
    return (t = M(t)).forEach(function(t) {
        var i = t.format ? t.format(+t._proportion_.toFixed(2)) : it.toFixed(100 * t._proportion_) + "%";
        e = Math.max(e, c(i));
    }), e;
}
...
function L(t, e, i) {
    ...
    for (var s = h(a, o), l = s.minRange, c = [], d = (s.maxRange - l) / i.yAxisSplit, u = 0; u <= i.yAxisSplit; u++) c.push(l + d * u);
    return c.reverse();
}

function k(t, e, i) {
    var n = L(t, e, i), a = i.yAxisWidth, o = n.map(function(t) {
        return t = it.toFixed(t, 2), t = e.yAxis.format ? e.yAxis.format(Number(t)) : t, 
...
function C(t, e, i, n, a, o) {
    var r = null;
    i[0].data.forEach(function(t, e) {
        t == a && (r = e);
    }), n.beginPath(), n.setStrokeStyle("#ffffff"), n.setLineWidth(0), n.setFillStyle(o);
    var s = t[r];
    n.moveTo(s.x + 3.5, s.y), n.arc(s.x, s.y, 3, 0, 2 * Math.PI, !1), n.closePath(), 
    n.fill();
}

function I(t, e, i, n) {
    n.beginPath(), n.setStrokeStyle("#ffffff"), n.setLineWidth(0), n.setFillStyle(e), 
    "diamond" === i ? t.forEach(function(t, e) {
        ...
        null !== t && (n.moveTo(t.x + 3.5, t.y), n.arc(t.x, t.y, 3, 0, 2 * Math.PI, !1));
...
function H(t, e, i) {
    ...
    if (r) {
        var d = c(r, a), u = (t.width - d) / 2 + (t.subtitle.offsetX || 0), x = (t.height - e.legendHeight + a) / 2;
        o && (x -= (h + 5) / 2), i.beginPath(), i.setFontSize(a), i.setFillStyle(l), i.fillText(r, u, x), 
...
function D(t, e, i, n, a, o) {
    ...
    t.forEach(function(t, s) {
        ...
        it.approximatelyEqual(l.x, 0) ? f -= c(n.categories[s] || "") / 2 : l.x < 0 && (f -= c(n.categories[s] || "")), 
...
function W(t, e, i, n, a, o) {
    ...
    t.map(function(t) {
        return {
            ...
            text: t.format ? t.format(+t._proportion_.toFixed(2)) : it.toFixed(100 * t._proportion_) + "%",
            color: t.color
        };
    }).forEach(function(t) {
        var e = Math.cos(t.arc) * l, n = Math.sin(t.arc) * l, o = Math.cos(t.arc) * a, r = Math.sin(t.arc) * a, d = e >= 0 ? e + i.pieChartTextPadding : e - i.pieChartTextPadding, u = n, x = c(t.text), g = u;
        f && it.isSameXCoordinateArea(f.start, {
            x: d
        }) && (g = d > 0 ? Math.min(u, f.start.y) : e < 0 ? Math.max(u, f.start.y) : u > 0 ? Math.max(u, f.start.y) : Math.min(u, f.start.y)), 
        d < 0 && (d -= x);
        var p = {
            lineStart: {
                x: o,
...
function R(t, e, i, n) {
    ...
    t.forEach(function(o, r) {
        ...
        var f = w(o.data, h, c, s, l, e, i, a);
        f = E(f, l, t.length, r, i, e), !1 !== e.dataLabel && 1 === a && z(f, o, i, n);
    }), n.restore(), {
        xAxisPoints: s,
        eachSpacing: l
    };
...
function q(t, e, i, n) {
    var a = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : 1, r = k(t, e, i).ranges, s = F(e.categories, e, i), l = s.xAxisPoints, h = s.eachSpacing, c = r.pop(), f = r.shift(), d = e.height - i.padding - i.xAxisHeight - i.legendHeight, u = [];
    return n.save(), e._scrollDistance_ && 0 !== e._scrollDistance_ && !0 === e.enableScroll && n.translate(e._scrollDistance_, 0), 
    e.tooltip && e.tooltip.textList && e.tooltip.textList.length && 1 === a && O(e.tooltip.offset.x, e, i, n), 
    t.forEach(function(t, r) {
        var s = w(t.data, c, f, l, h, e, i, a);
        if (u.push(s), S(s).forEach(function(i) {
        ...
        z(w(t.data, c, f, l, h, e, i, a), t, i, n);
    }), n.restore(), {
        xAxisPoints: l,
        calPoints: u,
        eachSpacing: h
...
function B(t, e, i, n) {
    ...
    t.forEach(function(r, s) {
        var u = w(r.data, c, f, l, h, e, i, a);
        if (d.push(u), S(u).forEach(function(t, i) {
            n.beginPath(), n.setStrokeStyle(r.color), n.setLineWidth(2), 1 === t.length ? (n.moveTo(t[0].x, t[0].y), 
            n.arc(t[0].x, t[0].y, 1, 0, 2 * Math.PI)) : (n.moveTo(t[0].x, t[0].y), "curve" === e.extra.lineStyle ? t.forEach(function(e, i) {
                if (i > 0) {
                    var a = o(t, i - 1);
                ...
                e > 0 && n.lineTo(t.x, t.y);
            }), n.moveTo(t[0].x, t[0].y)), n.closePath(), n.stroke();
        }), !1 !== e.dataPointShape) {
            var x = i.dataPointShape[s % i.dataPointShape.length];
            I(u, r.color, x, n), C(u, r.color, t, n, e.nowPrice, e.pricecolor);
        }
    }), !1 !== e.dataLabel && 1 === a && t.forEach(function(t, o) {
        z(w(t.data, c, f, l, h, e, i, a), t, i, n);
    }), n.restore(), {
...
function j(t, e, i, n) {
    ...
    t.tooltip && t.tooltip.textList && t.tooltip.textList.length && 1 === n && X(t.tooltip.textList, t.tooltip.offset, t, e, i), 
    i.restore();
}

function N(t, e, i, n) {
    var o = F(t, e, i), r = o.xAxisPoints, s = (o.startX, o.endX, o.eachSpacing), l = e.height - i.padding - i.xAxisHeight - i.legendHeight;
    i.xAxisLineHeight;
    n.save(), e._scrollDistance_ && 0 !== e._scrollDistance_ && n.translate(e._scrollDistance_, 0), 
    n.beginPath(), n.setStrokeStyle(e.xAxis.gridColor || "#cccccc"), n.closePath(), 
    n.stroke();
    var h = e.width - 2 * i.padding - i.yAxisWidth - i.yAxisTitleWidth, f = Math.min(t.length, Math.ceil(h / i.fontSize / 1.5)), d = Math.ceil(t.length / f);
    ...
    t.forEach(function(t, e) {
        ...
        var h = c(t), f = s / 2 - h, d = a(r[o] + s / 2, l + i.fontSize / 2 + 5, e.height), u = d.transX, x = d.transY;
        n.rotate(-1 * i._xAxisTextAngle_), n.translate(u, x), n.fillText(t, r[o] + f, l + i.fontSize + 5), 
...
function Z(t, e, i, n) {
    if (!0 !== e.yAxis.disabled) {
        ...
        }), n.closePath(), n.stroke(), e.yAxis.title && G(e.yAxis.title, e, i, n);
    }
}
...
function Q(t, e, i, n) {
    var a = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : 1, o = e.extra.radar || {}, s = x(e.categories.length), l = {
        x: e.width / 2,
        y: (e.height - i.legendHeight) / 2
    }, h = Math.min(l.x - (u(e.categories) + i.radarLabelTextMargin), l.y - i.radarLabelTextMargin);
...
function V(t) {
    ...
    var e = "undefined" != typeof requestAnimationFrame ? requestAnimationFrame : "undefined" != typeof setTimeout ? function(t, e) {
        ...
        if (null === i && (i = a), a - i < t.duration) {
            ...
            o = (0, nt[t.timing])(o), t.onProcess && t.onProcess(o), e(n, 17);
    ...
    switch (this.animationInstance && this.animationInstance.stop(), t) {
      case "line":
        this.animationInstance = new V({
            ...
            onProcess: function(t) {
                Y(e, i, n);
                var s = B(o, e, i, n, t), l = s.xAxisPoints, h = s.calPoints, c = s.eachSpacing;
                a.chartData.xAxisPoints = l, a.chartData.calPoints = h, a.chartData.eachSpacing = c, 
                N(r, e, i, n), Z(o, e, i, n), U(e, n);
            },
      ...
      case "column":
        this.animationInstance = new V({
            ...
            onProcess: function(t) {
                Y(e, i, n);
                var s = R(o, e, i, n, t), l = s.xAxisPoints, h = s.eachSpacing;
                a.chartData.xAxisPoints = l, a.chartData.eachSpacing = h, N(r, e, i, n), J(e.series, e, i, n), 
                Z(o, e, i, n), U(e, n);
            },
            onAnimationFinish: function() {
                a.event.trigger("renderComplete");
      ...
      case "area":
        this.animationInstance = new V({
            ...
            onProcess: function(t) {
                ...
                a.chartData.xAxisPoints = l, a.chartData.calPoints = h, a.chartData.eachSpacing = c, 
                N(r, e, i, n), J(e.series, e, i, n), Z(o, e, i, n), j(e, i, n, t), U(e, n);
            },
            onAnimationFinish: function() {
                a.event.trigger("renderComplete");
            }
      ...
      case "pie":
        this.animationInstance = new V({
            ...
            duration: u,
            onProcess: function(t) {
                a.chartData.pieData = K(o, e, i, n, t), J(e.series, e, i, n), U(e, n);
            },
            onAnimationFinish: function() {
                a.event.trigger("renderComplete");
            }
      ...
      case "radar":
        this.animationInstance = new V({
            ...
            duration: u,
            onProcess: function(t) {
                a.chartData.radarData = Q(o, e, i, n, t), J(e.series, e, i, n), U(e, n);
            },
            onAnimationFinish: function() {
                a.event.trigger("renderComplete");
            }
...
var et = {
    ...
    colors: [ "#ccc", "#f7a35c", "#434348", "#90ed7d", "#f15c80", "#8085e9" ],
...
V.prototype.stop = function() {
    this.isStop = !0;
}, tt.prototype.addEventListener = function(t, e) {
    this.events[t] = this.events[t] || [], this.events[t].push(e);
}, tt.prototype.trigger = function() {
...
var at = function(e) {
    ...
    this.chartData = {}, this.event = new tt(), this.scrollOption = {
        currentOffset: 0,
        startTouchX: 0,
        distance: 0
    }, $.call(this, e.type, e, i, this.context);
};

at.prototype.updateData = function() {
    ...
    $.call(this, this.opts.type, this.opts, this.config, this.context);
}, at.prototype.stopAnimation = function() {
    this.animationInstance && this.animationInstance.stop();
}, at.prototype.addEventListener = function(t, e) {
    this.event.addEventListener(t, e);
}, at.prototype.getCurrentDataIndex = function(t) {
    ...
    return -1;
}, at.prototype.showToolTip = function(e) {
    ...
    if ("line" === this.opts.type || "area" === this.opts.type) {
        ...
        $.call(this, o.type, o, this.config, this.context);
    }
}, at.prototype.scrollStart = function(t) {
    ...
    if (e.touches[0] && !0 === this.opts.enableScroll) {
        ...
        $.call(this, r.type, r, this.config, this.context);
    }
}, at.prototype.scrollEnd = function(t) {
