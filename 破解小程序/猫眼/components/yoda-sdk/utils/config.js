...
var _rohr = require("./rohr-1.0.1.js"), _rohr2 = _interopRequireDefault(_rohr), rohrConfig = {
    i: 100019
}, domain = {
...
}, baseUrl = domain[getApp().getApiEnv()], feVersion = {
    slider: "0.1.0",
    sms: "0.1.0",
    image: "0.1.0",
    voice: "0.1.0",
    ...
    71: "滑块",
    79: "地址位置"
}, embedModule = [ 1, 4, 12, 15, 40, 71 ], source = 13, closeStatus = {
...
exports.baseUrl = baseUrl, exports.feVersion = feVersion, exports.modules = modules, 
exports.embedModule = embedModule, exports.source = source, exports.rohrConfig = rohrConfig, 
exports.rohr = _rohr2.default, exports.closeStatus = closeStatus;