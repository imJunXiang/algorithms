    ...
    return _createClass(t, [ {
        ...
        value: function(t, e, i) {
            ...
            $.length && $.forEach(function(t) {
                n.$com[t].$init(n.getWxPage(), e, n), n.$com[t].onLoad && n.$com[t].onLoad(), n.$com[t].$mixins.forEach(function(e) {
                    e.onLoad && e.onLoad.call(n.$com[t]);
                }), n.$com[t].$apply();
            });
        }
    }, {
        ...
        value: function(t, e) {
            ...
            for (o in t) {
                var s = o.replace(a, "");
                this.$data[s] = _util2.default.$copy(t[o], !0);
            }
            return this.$wxpage.setData(t);
        }
    }, {
        ...
        value: function() {
            ...
            for (this.$$phase = "$digest"; this.$$phase; ) {
                var n = {};
                ...
                Object.keys(n).length && this.setData(n), this.$$phase = "$apply" === this.$$phase && "$digest";
            }
        }
    } ]), t;
}();
